...
## By household type
# Group 1
color_1 <- "#8ec68e" #8ec68e green
# Group 2
color_2 <- "#8e8df8"  #8e8df8 purple
# Group 3
color_3 <- "#8bcae0"  #8bcae0 blue 
...
# Add density line
# remove lines so just the fill is visible so median line can also appear
...
#     +
  ...
  scale_fill_manual(name = "Legend",
                    ...
                    breaks = c(unique(df$grouping)),
                    labels = c(unique(df$grouping))) +

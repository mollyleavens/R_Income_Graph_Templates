...
variable names, graph label information, colors, etc, and after that, no changes would be required.
...
income_main_crop <- total_cocoa_income_2018
other_income <- 
total_hh_income <- total_hh_income_2018 
...
DF %>%
  ...
  geom_vline(aes(xintercept = mean(DF$total_hh_income_2018), 
                 color = "Income Mean"), key_glyph = "path") +
  # Add vertical line for median income
  geom_vline(aes(xintercept = median(DF$total_hh_income_2018), 

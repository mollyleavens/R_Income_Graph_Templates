...
theme_set(theme_get() + theme(text = element_text(color = "pink")))
...
The below code chunk allows you to define the order in which the groups - gender, household size, or other grouping variable - appear from left to right on the bar graphs.   

```{r}
## Replace the writing currently in all caps with 

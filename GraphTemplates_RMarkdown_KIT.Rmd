...
* Before knitting the R markdown into a PDF, there are two **necessary** actions for the user. First, load R libraries under "Load R libraries" code chunk. Second, enter data under "User-entered data" code chunk.

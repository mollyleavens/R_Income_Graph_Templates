...
# Add vertical lines for benchmarks by group   
  geom_vline(aes(xintercept = mean(df$benchmark[grouping == unique(df$grouping)[1]])), color = color_1, key_glyph = "path") +
  
    geom_vline(aes(xintercept = mean(df$benchmark[grouping == unique(df$grouping)[2]])), color = color_2, key_glyph = "path") +
  
    geom_vline(aes(xintercept = mean(df$benchmark[grouping == unique(df$grouping)[3]])), color = color_3, key_glyph = "path") +
  
    geom_vline(aes(xintercept = mean(df$benchmark[grouping == unique(df$grouping)[4]])), color = color_4, key_glyph = "path") +
